...
## v1.2 status
On `feat/prompt-overhaul`: Answer Format + naturalness · Coding solver · Pronunciation · story-teller
format · first-person persona · per-question regenerate · coding re-solve. Ready for one PR.
